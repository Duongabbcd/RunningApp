...
import com.ezt.runningapp.utils.Constants.ACTION_SHOW_TRACKING_FRAGMENT
...
import com.ezt.runningapp.utils.Constants.FASTEST_LOCATION_INTERVAL
import com.ezt.runningapp.utils.Constants.LOCATION_UPDATE_INTERVAL
import com.ezt.runningapp.utils.Constants.NOTIFICATION_ID
...
class TrackingService : LifecycleService() {
    ...
    private fun updateNotificationTrackingState(isTracking: Boolean) {
        ...
        if(!serviceKilled) {
            curNotificationBuilder = baseNotificationBuilder
                .addAction(R.drawable.icon_pause_black_24dp, notificationActionText, pendingIntent)
